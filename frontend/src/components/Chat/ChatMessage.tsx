      ...
      <div className="flex flex-col items-end mb-4 animate-fade-in">
        <div className="flex items-end">
          <div className="order-2 mx-2 flex flex-col items-end">
            <div className="px-4 py-3 rounded-t-lg rounded-bl-lg bg-blue-600 text-white max-w-md break-words">
              {message.content}
            </div>
    ...
    <div className="flex flex-col mb-4 animate-fade-in">
      <div className="flex items-end">
        ...
        <div className="mx-2 flex flex-col">
          <div 
            className="px-4 py-3 rounded-t-lg rounded-br-lg bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 max-w-md break-words"
